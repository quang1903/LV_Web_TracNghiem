// src/pages/teacher/HomeTeacher.jsx
...
const HomeTeacher = () => {
  ...
  const menuItems = [
    { path: '/teacher',           label: '🏠 Tổng quan' },
    { path: '/teacher/subjects',  label: '📚 Quản lý môn học' },
    { path: '/teacher/exams',     label: '📝 Quản lý bài thi' },
    { path: '/teacher/questions', label: '❓ Quản lý câu hỏi' },
    { path: '/teacher/classes',   label: '👥 Quản lý lớp học' },
    { path: '/teacher/results',   label: '📊 Kết quả sinh viên' },
  ];
      ...
      >
        <div className="p-5 border-b flex items-center justify-between flex-shrink-0">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Giảng viên</p>
          </div>
          <button
            onClick={() => setDrawerOpen(false)}
        ...
        <div className="p-4 border-t flex-shrink-0">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="min-w-0">
              <p className="font-medium text-sm truncate">{user?.name || 'Giảng viên'}</p>
